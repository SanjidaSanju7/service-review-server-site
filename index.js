...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.q5qwa13.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    ...
    try {
        ...
        // delete specific review with id
